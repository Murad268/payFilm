                    ...
                    <form method="post" action="{{route('admin.scriptwriters.store')}}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name[{{ $lang }}]" value="{{ old('name.' . $lang) }}" type="text" class="form-control" placeholder="Ssenaristin adını daxil edin">
                            </div>
                            @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input name='slug[{{$lang}}]' value="{{ old('slug.' . $lang) }}" type="text" class="form-control" placeholder="Ssenarist slug daxil edin">
                            </div>
                            @error("slug.$lang")
                            <div class="alert alert-danger mt-2" role="alert">
                                {{ $message }}
