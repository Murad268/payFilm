                    ...
                    <form method="post" action="{{route('admin.seasons.update', $season->id)}}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="season_name[{{ $lang }}]" value="{{ old('season_name.' . $lang, $season->season_name) }}" type="text" class="form-control" placeholder="Sezonun adını daxil edin">
                            </div>
                            @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input name='slug[{{$lang}}]' value="{{ old('slug.' . $lang, $season->slug) }}" type="text" class="form-control" placeholder="Sezon slug daxil edin">
                            </div>
                            @error("slug.$lang")
                            <div class="alert alert-danger mt-2" role="alert">
                                {{ $message }}
